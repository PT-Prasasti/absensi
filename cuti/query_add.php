...
if ($sisaCutiSebelumnya >= $lama) {
    ...
    echo "<script>alert('Data Pengajuan Cuti Terkirim');window.location='index.php?nip=$nip'</script>";
} else {
    echo "<script>alert('Gagal mengajukan cuti. Sisa cuti tidak mencukupi');window.location='index.php?nip=$nip'</script>";
}
?>
