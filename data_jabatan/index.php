        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-6 mt-3 mb-3">
                    <h5 class="h3 mb-0 text-gray-800">Data Jabatan / Posisi</h5>
                </div>
                        ...
                        <table class='table table-striped' id="table1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nama Jabatan / Posisi</th>
                                    <th class="text-center"><i class="nav-icon fa fa-cog"></i></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                ?>
                                <tr>
                                    <td class="text-center"><?php echo $data['kode_jabatan'] ?></td>
                                    <td><?php echo $data['nama_jabatan'] ?></td>
                                    <td class="text-center">
                                        <a href='form_edit.php?kode_jabatan=<?php echo $data['kode_jabatan']; ?> '>
                                            <i data-feather="edit" class="mr-1 text-warning" aria-hidden="true"></i>|
                                        </a>
                                        <a onclick="hapus('<?php echo $data['kode_jabatan']; ?>')" data-toggle="modal" data-target="#modal-delete">
...
<script>
    function hapus(id){
        ...
        hps.href = 'query_delete.php?kode_jabatan='+id;
    }
</script>
