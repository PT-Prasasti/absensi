...
?>
                                ...
                                <table class="table mb-0" id="">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Lama Tidak Masuk</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="text-danger" onclick="hapus('<?php echo $data['kode_izin']; ?>')" data-toggle="modal" data-target="#modal-delete">
    ...
    <script>
    function hapus(kode_izin){
        var hps = document.querySelector('#delete');
        hps.href = 'query_delete.php?kode_izin='+kode_izin;
    }
    </script>
