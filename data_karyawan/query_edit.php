...
$query="UPDATE karyawan SET nik='$nik',nama='$nama',tempat_lahir='$tempat_lahir',tgl_lahir='$tgl_lahir',gender='$gender',telepon='$telepon', alamat='$alamat',kode_jabatan='$kode_jabatan',tgl_kerja='$tgl_kerja',foto='$foto' where nip='$nip'";
...
function uploadFile($nik, $upload, $file, $tujuan){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
        if($ukuran < 1044070){			
            ...
            echo "<script>alert('Ukuran file $upload terlalu besar'); window.location='form_edit.php'</script>";
            return;
        }
    }
    return $file;
