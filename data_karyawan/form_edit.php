                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="nik" value="<?php echo $row['nik'];?>" required placeholder="NIK">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" class="form-control" name="tempat_lahir" placeholder="Tempat Lahir" value="<?php echo $row['tempat_lahir'];?>" required>
                                        </div>
                                        <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="tgl_kerja" value="<?php echo $row['tgl_kerja'];?>" placeholder="" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <img src="foto/<?php echo $data['foto'] ?>" alt="" style="width: 100px;">
                                    </div>
                                </div>
                            </div>
