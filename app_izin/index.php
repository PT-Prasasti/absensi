                        ...
                        <div class="card-body px-0 pb-0">
                            <div class="table-responsive">
                                <table class="table mb-0" id="table1">
                                    ...
                                    <tbody>
                                        <?php
                                            $query ="select * from izin join karyawan on izin.`nip`= karyawan.`nip` where izin.`status` = 'Approve Hod'";
                                                ...
                                                <form method="post" action="query_edit.php" enctype="multipart/form-data">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalCenterTitle">Approval Status izin</h5>
